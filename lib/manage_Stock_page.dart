...
class _manage_Stock_pageState extends State<manage_Stock_page> {
  ...
  void addToDB(dynamic name) async {
    String date = DateTime.now().toString().substring(0, 10);
    String up = productUpController.text;
    String down = productDownController.text;
    String total = productTotalController.text;
  ...
  final productUpController = TextEditingController();
  final productDownController = TextEditingController();
                ...
                actions: <Widget>[
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      ...
                      if (selectStock[0].code.toString() !=
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    Visibility(
                                      ...
                                      child: selectStock[0].image!.toString() ==
                                              '' //IF DB DOESN'T HAVE IMAGE
                                          ? Image.asset(
                                              // SHOW TAKOYAKI
